...
/* indicate whether the currently-starting image is our loader chain, for
 * ExitBootServices hooks etc.  BOOLEAN matches the values assigned in code
 * (TRUE/FALSE) and avoids confusion with integer types. */
